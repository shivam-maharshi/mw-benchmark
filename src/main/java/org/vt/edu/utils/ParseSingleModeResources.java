 ...
 */
public class ParseSingleModeResources {

  public static void main(String[] args) {
    ParseSingleModeResources ps = new ParseSingleModeResources();
    String out = "C:/Users/Sam/Desktop/mode-d/scsn/scsnr.csv";
    String in = "C:/Users/Sam/Desktop/mode-d/scsn/";
    Map<Long, List<Resource>> res = ps.computeAvgResources(in);
    List<String> l = new ArrayList<>();
    l.add(",CPU,,,RAM,,,NET-READ,,,NET-WRITE,,,DISK-READ,,,DISK-WRITE");
    for (Long k : res.keySet()) {
      List<Resource> rl = res.get(k);
      for (Resource r : rl) {
        StringBuilder sb = new StringBuilder();
        sb.append(k).append(",").append(r.getCpu()).append(",,");
        sb.append(k).append(",").append(r.getRam()).append(",,");
        sb.append(k).append(",").append(r.getNetread()).append(",,");
        sb.append(k).append(",").append(r.getNetwrite()).append(",,");
        sb.append(k).append(",").append(r.getDiskread()).append(",,");
        sb.append(k).append(",").append(r.getDiskwrite()).append(",,");
        l.add(sb.toString());
      }
    }
  ...
  public Map<Long, List<Resource>> computeAvgResources(String modesFolder) {
